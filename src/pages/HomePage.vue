...
import Newsletters from '@/components/partials/commons/EmailNewsletters.vue';
...
import Clothings from '@/components/partials/homepage/default/ClothingsComponent.vue';
